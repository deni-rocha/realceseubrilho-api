...
export class Init1751113281146 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payments_method_enum" AS ENUM('CREDIT_CARD', 'PAYPAL', 'BANK_TRANSFER', 'PIX')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "shopping_carts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, CONSTRAINT "REL_7d5a425bf2a31aa1002a041ebb" UNIQUE ("user_id"), CONSTRAINT "PK_7420877774b880a61269dda7e8a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cart_items" ADD CONSTRAINT "FK_6385a745d9e12a89b859bb25623" FOREIGN KEY ("cart_id") REFERENCES "shopping_carts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "shopping_carts" ADD CONSTRAINT "FK_7d5a425bf2a31aa1002a041ebb6" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "shopping_carts" DROP CONSTRAINT "FK_7d5a425bf2a31aa1002a041ebb6"`,
    );
    await queryRunner.query(
